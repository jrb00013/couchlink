...
**Desktop installers:** [docs/DESKTOP_CLIENT.md](docs/DESKTOP_CLIENT.md) (Windows zip + installer, Linux AppImage, macOS `.app`).  
**Play with a friend online:** [docs/PLAY_TOGETHER.md](docs/PLAY_TOGETHER.md).
